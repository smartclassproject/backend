...
exports.getReports = async (req, res) => {
  const results = await TermResult.find({ schoolId: req.user.schoolId, studentId: req.user.studentId }).populate('courseId', 'name code').sort({ academicYear: -1, term: -1, createdAt: -1 });
