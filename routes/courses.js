 ...
 *                 message:
 *                   type: string
 *                   example: "Access denied to this course"
 *       404:
 ...
 *                 message:
 *                   type: string
 *                   example: "Course code already exists in this school"
 *       500:
 *         description: Internal server error
 *         content:
 *           application/json:
 ...
 *                       message:
 *                         type: string
 *                         example: "Course name cannot exceed 100 characters"
 *       401:
 *         description: Unauthorized - Invalid or missing token
 *         content:
 *           application/json:
 ...
 *                   example: "Course not found"
 *       409:
 *         description: Conflict - Cannot delete course with active schedules
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                 message:
 *                   type: string
 *                   example: "Cannot delete course with active schedules"
 *       500:
 *         description: Internal server error
 *         content:
 *           application/json:
