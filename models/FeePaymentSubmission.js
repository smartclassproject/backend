...
const schema = new mongoose.Schema({
  ...
  paymentMethod: { type: String, enum: ['BANK_TRANSFER', 'MOMO', 'CASH_REFERENCE', 'CASH', 'CARD'], required: true },
  paymentReference: { type: String, trim: true, maxlength: 200 },
  paidAt: Date,
  proofUrl: { type: String, trim: true },
  proofAssetId: { type: mongoose.Schema.Types.ObjectId, ref: 'FileAsset' },
